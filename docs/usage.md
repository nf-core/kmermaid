...
```bash
nextflow run nf-core/kmermaid --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/kmermaid`](https://hub.docker.com/r/nfcore/kmermaid/)
* `singularity`
