<<<<<<< HEAD
# nf-core/kmer-similarity: Contributing Guidelines
...
For further information/help, please consult the [nf-core/kmermaid documentation](https://nf-co.re/kmermaid/docs) and don't hesitate to get in touch on the nf-core Slack [#kmermaid](https://nfcore.slack.com/channels/kmermaid) channel ([join our Slack here](https://nf-co.re/join/slack)).
>>>>>>> upstream/TEMPLATE
